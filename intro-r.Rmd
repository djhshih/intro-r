...
`data.frame` a special type of `list` where all the elements have the same length.
...
Implements the feature that caller's objects are not modified by a function.
